...
class _MASSAGESPageState extends State<MASSAGESPage> {
  ...
  Future<void> _fetchmassagess() async {
    setState(() {
      _loading = true;
      _error = null;
    });
    final box = await Hive.openBox('massagess');
    final cacheKey = 'massages_services';
    ...
    try {
      final response = await http.get(
        Uri.parse('$baseUrl/api/category?category=massages'),
      );
