...
class _AcrylicsNailsPageState extends State<AcrylicsNailsPage> {
  ...
  void initState() {
    ...
    _fetchAcrylicsNailss();
  }

  Future<void> _fetchAcrylicsNailss() async {
    setState(() {
      _loading = true;
      _error = null;
    });
    final box = await Hive.openBox('AcrylicsNailss');
    ...
    try {
      final response = await http.get(Uri.parse('https://wishlist.lipslay.com/api/category?category=acrylics-nails'));
                ...
                child: Container(
                  ...
                  child: TextField(
                    ...
                    decoration: const InputDecoration(
                      hintText: 'Search Acrylics Nails',
                      hintStyle: TextStyle(
                        color: AppColors.black,
                        fontFamily: 'Ubuntu',
                      ),
