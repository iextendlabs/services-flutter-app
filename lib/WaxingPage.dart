...
class _WaxingPageState extends State<WaxingPage> {
  ...
  final List<Map<String, dynamic>> Waxing = [
    {
            ...
            children: [
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemCount: filteredWaxing.length,
                  itemBuilder: (context, index) {
                    final freelancer = filteredWaxing[index];
