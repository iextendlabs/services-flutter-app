...
class LpgGas extends StatefulWidget {
  @override
  _LpgGasState createState() => _LpgGasState();
}

class _LpgGasState extends State<LpgGas> {
  // TextEditingController _searchController = TextEditingController();
  final List<Map<String, dynamic>> gentsServices = const [
    {
      'title': 'Sharjah LPG GAS',
      'stars': 4.5,
      'time': '60 MINS',
      'liked': false,
