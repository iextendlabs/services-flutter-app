...
class EarnAtHomePage extends StatefulWidget {
  const EarnAtHomePage({super.key});

  @override
  State<EarnAtHomePage> createState() => _EarnAtHomePageState();
}

class _EarnAtHomePageState extends State<EarnAtHomePage> {
