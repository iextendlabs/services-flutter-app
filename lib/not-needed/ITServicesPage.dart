...
class ITServicesPage extends StatefulWidget {
  const ITServicesPage({super.key});

  @override
  State<ITServicesPage> createState() => _ITServicesPageState();
}

class _ITServicesPageState extends State<ITServicesPage> {
                          ...
                          onTap: () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder:
                                    (context) => ItemView(
                                      slug: service['slug'], // Pass the slug or unique identifier// Added required price parameter
                                    ),
                              ),
                            );
                          },
