...
class SpotifyMarketing extends StatefulWidget {
  const SpotifyMarketing({super.key});

  @override
  State<SpotifyMarketing> createState() => _SpotifyMarketingState();
}

class _SpotifyMarketingState extends State<SpotifyMarketing> {
