...
class IndustryCoursesPage extends StatefulWidget {
  const IndustryCoursesPage({super.key});

  @override
  State<IndustryCoursesPage> createState() => _IndustryCoursesPageState();
}

class _IndustryCoursesPageState extends State<IndustryCoursesPage> {
