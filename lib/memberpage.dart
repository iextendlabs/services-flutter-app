...
class _OurMembersPageState extends State<OurMembersPage> {
  ...
  Widget build(BuildContext context) {
    final filteredMembers = staffMembers.where((member) {
      final name = (member['name'] ?? '').toString().toLowerCase();
      final id = (member['id'] ?? '').toString();
      return name.contains(searchText.toLowerCase()) || id.contains(searchText);
    }).toList();
                        ...
                        return GestureDetector(
                          onTap: () {
                            ...
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => StaffProfilePage(staffId: member['id']),
                              ),
                            );
                          },
                          child: Column(
                            children: [
                              CircleAvatar(
                                ...
                                backgroundImage: member['image'] != null && member['image'].toString().isNotEmpty
                                    ...
                                    : null,
                                child: member['image'] == null || member['image'].toString().isEmpty
