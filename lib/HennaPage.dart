...
class HennaPage extends StatefulWidget {
  ...
  @override
  State<HennaPage> createState() => _HennaPageState();
}

class _HennaPageState extends State<HennaPage> {
  String _searchText = '';
  ...
  Future<void> _fetchHennaServices() async {
    setState(() {
      _loading = true;
      _error = null;
    });
    final box = await Hive.openBox('hennaServices');
    final cacheKey = 'henna_services';
    ...
    try {
      final response = await http.get(Uri.parse('https://wishlist.lipslay.com/api/category?category=henna'));
  ...
  Widget build(BuildContext context) {
    final filteredHenna = _services.where((f) {
                ...
                child: _loading
                    ...
                    : _error != null
                        ...
                        : ListView.builder(
                            ...
                            itemCount: filteredHenna.length,
                            itemBuilder: (context, index) {
                              final service = filteredHenna[index];
