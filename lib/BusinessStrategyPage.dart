...
class BusinessStrategyPage extends StatefulWidget {
  const BusinessStrategyPage({super.key});

  @override
  State<BusinessStrategyPage> createState() => _BusinessStrategyPageState();
}

class _BusinessStrategyPageState extends State<BusinessStrategyPage> {
