...
class ManicurePedicurePage extends StatefulWidget {
  const ManicurePedicurePage({super.key});

  @override
  State<ManicurePedicurePage> createState() => _ManicurePedicurePageState();
}

class _ManicurePedicurePageState extends State<ManicurePedicurePage> {
  String _searchText = '';
  Offset _fabPosition = const Offset(0, 0);

  final List<Map<String, dynamic>> ManicurePedicure = [
    {
  ...
  Widget build(BuildContext context) {
    final filteredManicurePedicure =
        ManicurePedicure.where(
            ...
            children: [
                ...
                child: Container(
                  ...
                  child: TextField(
                    ...
                    decoration: const InputDecoration(
                      hintText: 'Search ManicurePedicure',
                      hintStyle: TextStyle(
                        color: AppColors.black,
                        fontFamily: 'Ubuntu',
                      ),
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemCount: filteredManicurePedicure.length,
                  itemBuilder: (context, index) {
                    final freelancer = filteredManicurePedicure[index];
