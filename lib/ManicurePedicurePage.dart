...
class _ManicurePedicurePageState extends State<ManicurePedicurePage> {
  ...
  void initState() {
    ...
    _fetchManicurePedicures();
  }

  Future<void> _fetchManicurePedicures() async {
    setState(() {
      _loading = true;
      _error = null;
    });
    final box = await Hive.openBox('ManicurePedicures');
    final cacheKey = 'ManicurePedicure_services';
    ...
    try {
      final response = await http.get(
        Uri.parse('$baseUrl/api/category?category=manicure-pedicure'),
      );
