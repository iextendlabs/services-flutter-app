...
class LadiesSalon2Page extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: AppColors.primarypageWhite, // Changed to primaryPageWhite as defined in AppColors.dart
      appBar: AppBar(
        // toolbarHeight: 0, // <--- REMOVE OR COMMENT OUT THIS LINE
        centerTitle: true,
        elevation: 0, // Keep elevation 0 for a flat look
        backgroundColor: AppColors.primarypageWhite, // Match scaffold background
  leading: IconButton(
    icon: const Icon(Icons.arrow_back, color: AppColors.black), // Assuming AppColors.black is defined
    onPressed: () {
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: const TextField(
                      decoration: InputDecoration(
                        ...
                        prefixIcon: Icon(Icons.search, color: AppColors.accentColor), // Assuming AppColors.accentColor is defined
                  ...
                  const Text(
                    ...
                    style: TextStyle(
                      fontSize: 24,
                      fontWeight: FontWeight.bold,
                      color: AppColors.black87, // Assuming AppColors.black87 is defined
                    ),
                  ),
                  const SizedBox(height: 24),
                ],
          ...
          SliverPadding(
            ...
            sliver: SliverGrid(
              gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                ...
                childAspectRatio: 1.8, // Adjust as needed to match card proportions
              ),
  ...
  Widget _buildCategoryCard(ServiceCategory category) {
    return Container(
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: AppColors.calenderblueGrey.withOpacity(0.1), // Assuming AppColors.calenderBlueGrey is defined
            spreadRadius: 1,
            blurRadius: 5,
      ...
      child: Material(
        color: AppColors.transparent, // Make Material transparent to show Container's decoration
        child: InkWell(
          borderRadius: BorderRadius.circular(12.0),
          onTap: () {
            // Handle tap on category card
            // ignore: avoid_print
            ...
            child: Row(
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: AppColors.grey100, // Light background for icons, assuming AppColors.grey100
                  ...
                  child: ClipRRect(
                    ...
                    child: Image.asset(
                      ...
                      errorBuilder: (context, error, stackTrace) {
                        return const Icon(
                          Icons.broken_image,
                          color: AppColors.red, // Assuming AppColors.red is defined
