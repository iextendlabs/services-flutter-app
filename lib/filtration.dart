...
class FiltrationEquipments extends StatefulWidget {
  const FiltrationEquipments({super.key});

  @override
  State<FiltrationEquipments> createState() => _FiltrationEquipmentsState();
}

class _FiltrationEquipmentsState extends State<FiltrationEquipments> {
