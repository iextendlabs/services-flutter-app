...
class MediaCoursesPage extends StatefulWidget {
  const MediaCoursesPage({super.key});

  @override
  State<MediaCoursesPage> createState() => _MediaCoursesPageState();
}

class _MediaCoursesPageState extends State<MediaCoursesPage> {
