...
class EcommerceStock extends StatefulWidget {
  const EcommerceStock({super.key});

  @override
  State<EcommerceStock> createState() => _EcommerceStockState();
}

class _EcommerceStockState extends State<EcommerceStock> {
