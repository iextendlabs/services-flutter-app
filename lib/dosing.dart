...
class DosingEquipments extends StatefulWidget {
  const DosingEquipments({super.key});

  @override
  State<DosingEquipments> createState() => _DosingEquipmentsState();
}

class _DosingEquipmentsState extends State<DosingEquipments> {
