...
class BusinessLawPage extends StatefulWidget {
  const BusinessLawPage({super.key});

  @override
  State<BusinessLawPage> createState() => _BusinessLawPageState();
}

class _BusinessLawPageState extends State<BusinessLawPage> {
