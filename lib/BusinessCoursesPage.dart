...
class BusinessCoursesPage extends StatefulWidget {
  const BusinessCoursesPage({super.key});

  @override
  State<BusinessCoursesPage> createState() => _BusinessCoursesPageState();
}

class _BusinessCoursesPageState extends State<BusinessCoursesPage> {
