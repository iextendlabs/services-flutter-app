...
class _PlumberServicePageState extends State<PlumberServicePage> {
  ...
  void initState() {
    ...
    _fetchPlumberServices();
  }

  Future<void> _fetchPlumberServices() async {
    setState(() {
      _loading = true;
      _error = null;
    });
    final box = await Hive.openBox('PlumberServices');
    final cacheKey = 'PlumberService_services';
    ...
    try {
      final response = await http.get(
        Uri.parse('$baseUrl/api/category?category=plumber-service'),
      );
