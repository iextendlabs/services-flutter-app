...
class FrenchTipAcryilcsNailsPage extends StatefulWidget {
  ...
  @override
  State<FrenchTipAcryilcsNailsPage> createState() =>
      _FrenchTipAcryilcsNailsPageState();
}

class _FrenchTipAcryilcsNailsPageState
    extends State<FrenchTipAcryilcsNailsPage> {
  String _searchText = '';
  ...
  Future<void> _fetchFrenchTipAcryilcsNailss() async {
    ...
    try {
      final response = await http.get(
        Uri.parse('$baseUrl/api/category?category=french-tip-acrylics-nails'),
      );
