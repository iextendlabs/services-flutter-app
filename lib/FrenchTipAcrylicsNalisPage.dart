...
class FrenchtipAcrylicsNailsPage extends StatefulWidget {
  const FrenchtipAcrylicsNailsPage({super.key});

  @override
  State<FrenchtipAcrylicsNailsPage> createState() => _FrenchtipAcrylicsNailsPageState();
}

class _FrenchtipAcrylicsNailsPageState extends State<FrenchtipAcrylicsNailsPage> {
  String _searchText = '';
  Offset _fabPosition = const Offset(0, 0);

  final List<Map<String, dynamic>> FrenchTipNails = [
    {
