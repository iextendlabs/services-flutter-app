...
class FrenchTipAcryilcsNailsPage extends StatefulWidget {
  const FrenchTipAcryilcsNailsPage({super.key});

  @override
  State<FrenchTipAcryilcsNailsPage> createState() => _FrenchTipAcryilcsNailsPageState();
}

class _FrenchTipAcryilcsNailsPageState extends State<FrenchTipAcryilcsNailsPage> {
  String _searchText = '';
  ...
  void initState() {
    ...
    _fetchFrenchTipAcryilcsNailss();
  }

  Future<void> _fetchFrenchTipAcryilcsNailss() async {
    setState(() {
      _loading = true;
      _error = null;
    });
    final box = await Hive.openBox('FrenchTipAcryilcsNailss');
    ...
    try {
      final response = await http.get(Uri.parse('https://wishlist.lipslay.com/api/category?category=french-tip-acrylics-nails'));
                ...
                child: Container(
                  ...
                  child: TextField(
                    ...
                    decoration: const InputDecoration(
                      hintText: 'Search FrenchTipAcryilcsNails',
                      hintStyle: TextStyle(
                        color: AppColors.black,
                        fontFamily: 'Ubuntu',
                      ),
