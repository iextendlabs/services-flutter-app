...
class BleachThreadingPage extends StatefulWidget {
  const BleachThreadingPage({super.key});

  @override
  State<BleachThreadingPage> createState() => _BleachThreadingPageState();
}

class _BleachThreadingPageState extends State<BleachThreadingPage> {
  String _searchText = '';
  Offset _fabPosition = const Offset(0, 0);

  final List<Map<String, dynamic>> BleachThreading = [
    {
  ...
  Widget build(BuildContext context) {
    final filteredBleachThreading =
        BleachThreading.where(
            ...
            children: [
                ...
                child: Container(
                  ...
                  child: TextField(
                    ...
                    decoration: const InputDecoration(
                      hintText: 'Search BleachThreading',
                      hintStyle: TextStyle(
                        color: AppColors.black,
                        fontFamily: 'Ubuntu',
                      ),
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemCount: filteredBleachThreading.length,
                  itemBuilder: (context, index) {
                    final freelancer = filteredBleachThreading[index];
