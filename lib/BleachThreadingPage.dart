...
class _BleachThreadingPageState extends State<BleachThreadingPage> {
  ...
  void initState() {
    ...
    _fetchBleachThreadings();
  }

  Future<void> _fetchBleachThreadings() async {
    setState(() {
      _loading = true;
      _error = null;
    });
    final box = await Hive.openBox('BleachThreadings');
    final cacheKey = 'bleachthreading_services';
    ...
    try {
      final response = await http.get(
        Uri.parse('$baseUrl/api/category?category=bleach-threading'),
      );
