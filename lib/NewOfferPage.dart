...
class _NewOfferPageState extends State<NewOfferPage> {
  ...
  Future<void> _fetchNewOffers() async {
    ...
    final box = await Hive.openBox('NewOffers');
    ...
    try {
      final response = await http.get(Uri.parse('https://wishlist.lipslay.com/api/category?category=new-offer'));
